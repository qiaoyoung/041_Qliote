...
class VideoQliotePage extends StatefulWidget {
  final String videoPath;
  final Map<String, dynamic> character;

  const VideoQliotePage({
    super.key,
  ...
  @override
  State<VideoQliotePage> createState() => _VideoQliotePageState();
}

class _VideoQliotePageState extends State<VideoQliotePage> {
  ...
  Future<void> _initializeVideo() async {
    try {
      ...
      // Path format from JSON: "assets/qliotefigure/1/character_1_video_1.mp4"
  ...
  String _getAvatarPath() {
    return widget.character['QlioteUserIcon'] ?? '';
  }
  ...
  Widget build(BuildContext context) {
    ...
    final nickname = widget.character['QlioteNickName'] ?? '';
