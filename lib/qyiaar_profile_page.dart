...
import 'qyiaar_editor_page.dart';
import 'Voice_history_page.dart';

class QyiaarProfilePage extends StatefulWidget {
  const QyiaarProfilePage({super.key});

  @override
  State<QyiaarProfilePage> createState() => _QyiaarProfilePageState();
}

class _QyiaarProfilePageState extends State<QyiaarProfilePage> with WidgetsBindingObserver {
  String _nickname = 'Qyiaar';
  String? _avatarPath;
  ...
  Future<void> _loadUserData() async {
    ...
    setState(() {
      _nickname = prefs.getString('user_nickname') ?? 'Qyiaar';
  ...
  Future<void> _shareApp() async {
    try {
      ...
      const String shareText = 'Check out Qyiaar app! $appStoreUrl';
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          _buildMenuItem(
            imagePath: 'assets/profile_qyiaar_terms.png',
          ...
          _buildMenuItem(
            imagePath: 'assets/profile_qyiaar_privacy.png',
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          const SizedBox(height: 16),
          _buildMenuItem(
            imagePath: 'assets/profile_qyiaar_editor.png',
            title: 'Editor Info',
            onTap: () async {
              final result = await Navigator.push(
                context,
                MaterialPageRoute(
                  builder: (context) => const QyiaarEditorPage(),
                ),
              );
              if (result != null) {
                await _loadUserData();
          ...
          const Divider(height: 1, color: Color(0xFFE0E0E0)),
          _buildMenuItem(
            imagePath: 'assets/profile_qyiaar_share.png',
          ...
          const Divider(height: 1, color: Color(0xFFE0E0E0)),
          _buildMenuItem(
            imagePath: 'assets/profile_qyiaar_rate.png',
