...
class QlioteFigureDetailPage extends StatefulWidget {
  final Map<String, dynamic> character;
  final VoidCallback? onDataChanged;

  const QlioteFigureDetailPage({
    super.key,
  ...
  @override
  State<QlioteFigureDetailPage> createState() => _QlioteFigureDetailPageState();
}

class _QlioteFigureDetailPageState extends State<QlioteFigureDetailPage> {
  ...
  Widget build(BuildContext context) {
    ...
    final nickname = widget.character['QlioteNickName'] as String? ?? '';
    final avatarPath = widget.character['QlioteUserIcon'] as String? ?? '';
    final motto = widget.character['QlioteShowMotto'] as String? ?? '';
    final photoArray = widget.character['QlioteShowPhotoArray'] as List<dynamic>? ?? [];
    final videoArray = widget.character['QlioteShowVideoArray'] as List<dynamic>? ?? [];
    final thumbnailArray = widget.character['QlioteShowThumbnailArray'] as List<dynamic>? ?? [];
