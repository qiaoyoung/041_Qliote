...
class QlioteEditorPage extends StatefulWidget {
  const QlioteEditorPage({super.key});

  @override
  State<QlioteEditorPage> createState() => _QlioteEditorPageState();
}

class _QlioteEditorPageState extends State<QlioteEditorPage> {
  ...
  Future<void> _loadUserData() async {
    ...
    setState(() {
      _nicknameController.text = prefs.getString('user_nickname') ?? 'Qliote';
