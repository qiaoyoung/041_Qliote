...
class QyiaarSpeechPage extends StatefulWidget {
  const QyiaarSpeechPage({super.key});

  @override
  State<QyiaarSpeechPage> createState() => _QyiaarSpeechPageState();
}

class _QyiaarSpeechPageState extends State<QyiaarSpeechPage> {
